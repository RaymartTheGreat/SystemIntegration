...
// Update the SQL query to join member_account and college_shirt_payment tables
$sql = "SELECT ma.*, csp.status 
        FROM member_account AS ma
        LEFT JOIN college_shirt_payment AS csp ON ma.id = csp.account_id";
...
<head>
    <title>IT Payment Dashboard - College Shirt</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>

<body>
    <div class="header">
        <h1>IT Payment Dashboard - College Shirt</h1>
            ...
            <table class="members-table">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<form method='POST' action='update_member_status_college_shirt.php'>";
                        ...
                        echo "<td>";
                        echo "<form method='POST' action='view_receipt_college_shirt.php' target='_blank'>";
                        echo "<input type='hidden' name='id' value='" . $row["id"] . "'>";
