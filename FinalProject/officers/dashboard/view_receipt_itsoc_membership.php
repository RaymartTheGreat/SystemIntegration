...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Fetch the receipt image from the itsoc_membership_payment table using account_id
    $sql = "SELECT payment_receipt FROM itsoc_membership_payment WHERE account_id=?";
