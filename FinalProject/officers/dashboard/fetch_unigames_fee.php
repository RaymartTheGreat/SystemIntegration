...
// Update the SQL query to join member_account and unigames_fee_payment tables
$sql = "SELECT ma.*, ufp.status 
        FROM member_account AS ma
        LEFT JOIN unigames_fee_payment AS ufp ON ma.id = ufp.account_id";
...
<head>
    <title>IT Payment Dashboard - Unigames Fee</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>

<body>
    <div class="header">
        <h1>IT Payment Dashboard - Unigames Fee</h1>
            ...
            <table class="members-table">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<form method='POST' action='update_member_status_unigames_fee.php'>";
                        ...
                        echo "<td>";
                        echo "<form method='POST' action='view_receipt_unigames_fee.php' target='_blank'>";
                        echo "<input type='hidden' name='id' value='" . $row["id"] . "'>";
