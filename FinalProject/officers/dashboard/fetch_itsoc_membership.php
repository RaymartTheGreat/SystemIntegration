...
// Update the SQL query to join member_account and itsoc_membership_payment tables
$sql = "SELECT ma.*, imp.status 
        FROM member_account AS ma
        LEFT JOIN itsoc_membership_payment AS imp ON ma.id = imp.account_id";
...
<head>
    <title>IT Payment Dashboard - ITSOC Membership</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>

<body>
    <div class="header">
        <h1>IT Payment Dashboard - ITSOC MEMBERSHIPs</h1>
            ...
            <table class="members-table">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<form method='POST' action='update_member_status_itsoc_membership.php'>";
                        ...
                        echo "<td>";
                        echo "<form method='POST' action='view_receipt_itsoc_membership.php' target='_blank'>";
                        echo "<input type='hidden' name='id' value='" . $row["id"] . "'>";
