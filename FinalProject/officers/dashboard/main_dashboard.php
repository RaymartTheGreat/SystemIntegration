...
<body>
    ...
    <div class="container">
        ...
        <div class="table-section">
            <div class="filter-form-container">
                ...
                <form class="print-form" action="print_table.php" method="GET">
                    <input type="hidden" name="year_level" value="<?php echo $filter['year_level']; ?>">
                    <input type="hidden" name="section" value="<?php echo $filter['section']; ?>">
                    <input type="hidden" name="status" value="<?php echo $filter['status']; ?>">
                    <input type="hidden" name="item_type" value="<?php echo $filter['item_type']; ?>">
                    <input type="hidden" name="search" value="<?php echo $filter['search']; ?>">
                </form>
    ...
    <script>
        function printPage() {
            ...
            const url = 'print_table.php?' + urlParams.toString();
